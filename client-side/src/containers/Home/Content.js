...
const Content = () => (
  ...
  <Box sx={{ mx: { xs: 4, lg: 15 }, mt: { xs: 18, md: 28, lg: 38 },}}>
    <Stack
      sx={{
    ...
    >
      <Box sx={{ flexBasis: "60%" }}>
        ...
        >
          ...
          <span style={{ color: "#D12F58" }}>ESI students</span>
        </Typography>
        <Typography
          variant="h6"
          sx={{
    ...
    <Box sx={{ mt: { xs: 24, lg: 30 } }}>
      ...
      >
        ...
        <span style={{ color: "#205BF1" }}>that can help others</span>
      </Typography>
      <Stack
        sx={{
          flexDirection: { xs: "column", md: "row" },
      ...
      >
        ...
        <Stack direction="column" flexBasis="40%">
          ...
          <Box className="content-box">
            ...
            >
              Specify the topics of the documents in order to save them in their
              designed location.
            </Typography>
          </Box>
        </Stack>
